...
from typing import Any, Tuple, Union, Type, TypeVar, Sequence, cast, Protocol, overload, TYPE_CHECKING
...
if TYPE_CHECKING:
    # For static type checkers, we need to provide the complete interface
    from typing_extensions import Self
    
    # More complete protocol that includes inherited methods
    class StructuredClass(Protocol):
        ...
        @classmethod
        def decode(cls, buffer: Union[bytes, bytearray, memoryview], offset: int = 0) -> Self: ...
        @classmethod
