...
def test_network_protocol():
    ...
    @struct
    class MessageHeader:
        version: Uint[8] = field(metadata={"default": Uint[8](1)})
        message_type: MessageType
        sequence_id: Uint[32]
        timestamp: Uint[64]
        flags: Uint[8] = field(metadata={"default": Uint[8](0)})
    ...
    class HeartbeatMessage:
        header: MessageHeader
        load_average: Uint[16] = field(metadata={"default": Uint[16](0)})
    ...
    auth_msg = AuthMessage(
        header=MessageHeader(
            ...
            sequence_id=Uint[32](1),
            timestamp=Uint[64](current_time)
        ),
    ...
    data_msg = DataMessage(
        header=MessageHeader(
            ...
            sequence_id=Uint[32](2),
            timestamp=Uint[64](current_time + 1000)
        ),
        payload=Bytes(data_payload),
        checksum=Uint[32](checksum),
    ...
    error_msg = ErrorMessage(
        header=MessageHeader(
            ...
            sequence_id=Uint[32](3),
            timestamp=Uint[64](current_time + 2000)
        ),
    ...
    heartbeat_msg = HeartbeatMessage(
        header=MessageHeader(
            ...
            sequence_id=Uint[32](4),
            timestamp=Uint[64](current_time + 3000)
        ),
        load_average=Uint[16](75)  # 75% load
    )
    ...
    config_msg = ConfigMessage(
        header=MessageHeader(
            ...
            sequence_id=Uint[32](5),
            timestamp=Uint[64](current_time + 4000)
        ),
        entries=TypedVector[ConfigEntry]([
...
def test_message_routing():
    ...
    class MessageRouter:
        ...
        def create_request(self, request_type: RequestType, user_id=None, data=None):
            request = RequestMessage(
                request_id=Uint[32](self.next_request_id),
                request_type=request_type,
                user_id=Option[Uint[32]](user_id) if user_id else Option[Uint[32]](),
    ...
    get_request = router.create_request(RequestType.GET_USER, user_id=Uint[32](1))
    get_response = router.process_request(get_request)
    assert bool(get_response.success) is True
    assert get_response.data
    
    # Test error cases
    missing_user_request = router.create_request(RequestType.GET_USER, user_id=Uint[32](999))
    ...
    unhandled_request = router.create_request(RequestType.UPDATE_USER, user_id=Uint[32](1))
...
def test_binary_protocol_comparison():
    ...
    class SensorReading:
        sensor_id: Uint[32]
        timestamp: Uint[64]
        temperature: Uint[32]  # Temperature * 100 (to avoid floats)
        humidity: Uint[16]     # Humidity * 100
        pressure: Uint[32]     # Pressure in pascals
        battery_level: Uint[8] # Battery percentage
    ...
    for i in range(10):  # 10 sensor readings
        reading = SensorReading(
            sensor_id=Uint[32](i + 1),
            timestamp=Uint[64](current_time + i * 60),  # 1 minute intervals
            temperature=Uint[32](2350 + i * 10),  # 23.50°C to 24.40°C
            humidity=Uint[16](4500 + i * 50),     # 45.00% to 49.50%
            pressure=Uint[32](101325 + i * 100), # ~1 atmosphere
            battery_level=Uint[8](95 - i)         # Declining battery
        )
    ...
    batch = SensorBatch(
        ...
        checksum=Uint[32](0xDEADBEEF)  # Mock checksum
    )
...
def test_network_message_types():
    ...
    class PingMessage:
        base: BaseMessage
        payload_size: Uint[16] = field(metadata={"default": Uint[16](0)})
    
    @struct
    class PongMessage:
        base: BaseMessage
        original_sequence: Uint[32]
        latency_ms: Uint[16]
    ...
    pong = PongMessage(
        base=BaseMessage(
            ...
            sequence=Uint[32](2),
            timestamp=Uint[64](current_time + 100)
        ),
        original_sequence=Uint[32](1),
        latency_ms=Uint[16](50)
    )
    ...
    data_transfer = DataTransferMessage(
        base=BaseMessage(
            ...
            sequence=Uint[32](3),
            timestamp=Uint[64](current_time + 200)
        ),
        chunk_id=Uint[32](1),
        total_chunks=Uint[32](10),
...
def test_complex_protocol_state():
    ...
    initial_state = ProtocolState(
        ...
        session_id=Option[String](),
        last_message_id=Uint[32](0),
        bytes_sent=Uint[64](0),
        bytes_received=Uint[64](0)
    )
    ...
    connect_state = ProtocolState(
        ...
        last_message_id=Uint[32](1),
        bytes_sent=Uint[64](100),
        bytes_received=Uint[64](50)
    )
    
    connect_msg = ProtocolMessage(
        message_type=MessageType.CONNECT,
        message_id=Uint[32](1),
        session_id=Option[String](String("session_123")),
    ...
    auth_state = ProtocolState(
        ...
        session_id=Option[String](String("session_123")),
        last_message_id=Uint[32](2),
        bytes_sent=Uint[64](250),
        bytes_received=Uint[64](180)
    )
    
    auth_msg = ProtocolMessage(
        message_type=MessageType.AUTH,
        message_id=Uint[32](2),
        session_id=Option[String](String("session_123")),
